...
config =
{
    ...
    award_animation_speeds: [
      { solved: 10, fastFlipSpeed: 2400, slowFlipSpeed: 4000, utuSpeedFunc: function(up_cnt) { return Math.min(500 + up_cnt * 100, 2000); } },
      { solved: 9,  fastFlipSpeed: 1600,  slowFlipSpeed: 2400, utuSpeedFunc: function(up_cnt) { return Math.min(500 + up_cnt * 100, 2000); } },
      { solved: 7,  fastFlipSpeed: 800,  slowFlipSpeed: 1200,  utuSpeedFunc: function(up_cnt) { return Math.min(500 + up_cnt * 100, 2000); } },
      { solved: 3,  fastFlipSpeed: 400,  slowFlipSpeed: 600,  utuSpeedFunc: function(up_cnt) { return Math.min(250 + up_cnt * 50, 3000); } },
      { solved: 0,  fastFlipSpeed: 400,  slowFlipSpeed: 600,  utuSpeedFunc: function(up_cnt) { return Math.min(150 + up_cnt * 30, 1000); } }
    ],
