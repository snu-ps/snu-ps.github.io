...
sheet: https://docs.google.com/spreadsheets/d/1Gw591-fsoTEY0atzD804ChDTE7rTwu4WgVsfkGKl0-E
apply: https://seoul2025.icpckorea.org/2025apply
toc:
  sidebar: left
---

## 0. [2025 예선 등록 안내](https://icpckorea.org/archives/3262)
등록 과정 중 어려움이 있으시면 SNUPS 회장 {{ site.president.name }}({{ site.president.phone }}) 또는 [{{ site.email }}](mailto:{{ site.email }})로 연락 바랍니다.

이 가이드는 2025년 기준으로 작성되었습니다. 등록 과정이 여러 단계고, 정보가 빠져 `PENDING` 되는 경우가 있으니 **여유를 두고 미리미리 시작합시다**.

- **2025 등록 일정 : 2025년 9월 5일 (금) 09:00 ~ 9월 19일 (금) 17:00**
- **2025 인터넷 예선 대회 일정 : 2025년 10월 10일 (금) 예비소집, 10월 11일 (토) 대회**
- **2025 본선 대회 일정 : 2025년 11월 21일 (금) 예비소집, 11월 22일 (토) 대회**
- [2025 FAQ](http://seoul2025.icpckorea.org/)
- [2025 서울대학교 등록 현황 시트]({{ page.sheet }})
- [2025 전체 등록 현황](https://icpc.global/regionals/finder/Seoul-First-Round-2026/teams)

<!-- 아래 주석은 문서 업데이트하실 때 운영사무국에 문의해서 주석 제거 또는 내용 삭제 부탁드립니다. -->
2025년 기준으로 다음의 조건을 모두 만족하는 분만 참여가 가능합니다. 부정 참가 적발 시에는 서울대학교 전체에 페널티가 가해질 수 있으니 주의해 주세요. 다른 형태의 군 복무 등 참가 자격에 대한 추가 심의가 필요한 경우 운영사무국으로 연락하시면 됩니다.
- 2025년 **본선 대회 당일에 학부 또는 대학원에 재학 중**일 것으로 예상됨.
...
- 2002년 이후 출생 **또는** 2021 이후 학번
<!--    - 학번은 지금까지 소속되었던 모든 대학 중 입학 시기가 가장 빠른 곳의 학번을 기준으로 합니다. -->
    - 단, 현역 복무의 경우 나이와 학번 기준에서 2년, 산업기능요원 복무의 경우 3년이 유예됩니다.
- 지금까지 학부 또는 대학원에서 **수료**한 학기의 수가 8보다 작거나 같음.
<!--    - 편입, 재수, 대학원 진학 등 학적 상태 변동이 있었더라도 지금까지 소속되었던 모든 대학에서 수료한 모든 학기를 포함합니다. -->
...
이메일함(또는 스팸함)을 확인해 6자리 정도의 인증 코드를 입력하고 `SUBMIT` 버튼을 누릅니다. 이메일이 오는 데 시간이 걸릴 수 있습니다.
...
---
<details>
  <summary>여기 접혀 있는 내용은 2024년 이전에는 했어야 하는 것들입니다. Extra Fields, People with access to your profile 또는 그와 유사한 메뉴가 보인다면 눕장에게 제보해 주세요.</summary>
  <img src="/assets/img/manual-icpc/old_13_extra.png" style="max-width: 100%;">
  <p>여기는 재학생이면 Y, 휴학생이면 N을 적으시면 됩니다. 이걸 적는 이유는 휴학생은 본선 참가를 할 수 없기 때문입니다... ㅠㅠ</p>
  <img src="/assets/img/manual-icpc/old_14_references.png" style="max-width: 100%;" >
  <p>추가 탭 3개를 다 채우셨다면, 여기 왼쪽에 있는 References 글자를 클릭해 주세요.</p>
  <img src="/assets/img/manual-icpc/old_15_threelines.png" style="max-width: 100%;">
  <p>혹시 이게 안 보이시면, 여기 줄 3개 그어진 아이콘을 먼저 클릭해 보세요.</p>
  <img src="/assets/img/manual-icpc/old_16_allow.png" style="max-width: 100%;">
  <p>People with access to your profile에서 위와 같이 코치 계정 허용까지 해 주시면 됩니다.<br>
  팀 등록이 끝나면 요청이 갈 겁니다. Accept만 해주시면 됩니다.</p>
</details>
---
...
내 팀이 eligible한지를 확인할 수 있습니다. 아래 사진처럼 `NO ISSUES FOUND`면 아무 문제가 없고, 만약 그렇지 않다면 클릭해서 상세 사유를 확인해 주세요. 다음 사유들은 서약서에서 `군휴학증명서`를 제출하셨으면 문제없습니다. 다른 이슈가 있다면 눕장에게 연락해 주세요.
